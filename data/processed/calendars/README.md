...
| Cleaning audit / decision tracking | `data/processed/calendars/calendars_cleaning_audit.csv` | 5 rows |
...
Outputs: `data/processed/calendars/` (cleaned datasets + `calendars_cleaning_audit.csv`).
